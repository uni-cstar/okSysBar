...
public class SystemBar {
     ...
     * @param color 状态栏背景色
     */
    public static void applyImmersiveStatusBar(@NonNull Activity activity, @ColorInt int color) {
     ...
     * @param ratio  比率
     */
    public static void applyImmersiveStatusBar(
     ...
     * @param color 状态栏颜色值
     */
    public static void applyStatusBarColor(@NonNull Activity activity, @ColorInt int color) {
     ...
     * @param ratio  比率，0-1
     */
    public static void applyStatusBarColor(@NonNull Activity activity,
                                           @ColorInt int color1,
                                           @ColorInt int color2,
                                           @FloatRange(from = 0.0, to = 1.0) float ratio
    ) {
     ...
     */
    public static void applyImmersiveNavigationBar(@NonNull Activity activity) {
     ...
     * @param color 导航栏背景色
     */
    public static void applyImmersiveNavigationBar(@NonNull Activity activity, @ColorInt int color) {
     ...
     * @param color 状态栏颜色值
     */
    public static void applyNavigationBarColor(@NonNull Activity activity, @ColorInt int color) {
     ...
     */
    public static void applyNavigationBarColor(@NonNull Activity activity,
                                               @ColorInt int color1,
                                               @ColorInt int color2,
                                               @FloatRange(from = 0.0, to = 1.0) float ratio
    ) {
     ...
     */
    public static void applyImmersiveSystemBar(@NonNull Activity activity) {
     ...
     * @param color 系统栏的背景色
     */
    public static void applyImmersiveSystemBar(@NonNull Activity activity, @ColorInt int color) {
     ...
     */
    public static void applySystemBarColor(@NonNull Activity activity, @ColorInt int color) {
     ...
     * 设置System Bar的颜色：即同时设置Status Bar和Navigation Bar的背景颜色
     */
    public static void applySystemBarColor(@NonNull Activity activity,
                                           @ColorInt int color1,
                                           @ColorInt int color2,
                                           @FloatRange(from = 0.0, to = 1.0) float ratio
    ) {
     ...
     */
    public static void applyStatusBarLightMode(@NonNull Activity activity) {
     ...
     */
    public static void applyStatusBarDarkMode(@NonNull Activity activity) {
